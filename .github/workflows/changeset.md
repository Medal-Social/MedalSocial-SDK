...
4. **Use the repository name as the package identifier** (@medalsocial/sdk)
...
- **Single Package Default**: If unsure about package structure, default to "@medalsocial/sdk"
