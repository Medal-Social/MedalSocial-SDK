...
If you find a security vulnerability in the Medal Social SDK, please report it responsibly.
...
- `@medalsocial/sdk` — TypeScript SDK client
- Authentication handling (bearer token, OAuth)
...
```bash
npm install @medalsocial/sdk@latest
```
